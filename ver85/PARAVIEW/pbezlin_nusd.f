...
!-----[--.----+----.----+----.-----------------------------------------]
!      Purpose: Construct Bezier mesh and Linear meshes with the
!               opportunity of anisotropic nurb element subdivision
...
!     Set linear mesh for plot use
      ...
      call pmsh_lin_nusd_new(mr(np(32)) , mr(np(33)) , hr(np(43)),
