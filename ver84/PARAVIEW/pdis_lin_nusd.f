...
c-----[--.----+----.----+----.-----------------------------------------]
c      Purpose: Project T-spline/NURBS to linear elements for plots with
c               the opportunity of anisotropic element subdivision
...
c        x_lin(ndf,*) - Quadrilateral coordinates

c      Outputs:
c        u_lin(ndf,*) - Quadrilateral solution
c-----[--+---------+---------+---------+---------+---------+---------+-]
      implicit   none
